 ...
 * @link http://shahbazov.com *
 */
@WebServlet(name = "BalusFileServlet", urlPatterns = {"/downloads/*", "/uysexport/*"},
        initParams = {
            @WebInitParam(name = "basePath", value = "/WEB-INF/uysexport")
        })
public class BalusFileServlet extends HttpServlet {
    ...
    protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (file.delete()) {
                logger.info(String.format("%s had been deleted", file.getName()));
            } else {
                logger.info(String.format("%s had not been deleted", file.getName()));
            }
        } catch (Exception exception) {
            logger.info("some error had been occured on delete");
        }
    ...
    private void processRequest(HttpServletRequest request, HttpServletResponse response, boolean content)
        ...
        switch (getBrowser(request)) {
            case Opera:
                ...
                break;
            case Firefox:
                response.setHeader("Content-Disposition", disposition + ";" + "filename*=UTF-8''" + downloadFileName);
                break;
            case Chrome:
            case IE:
    ...
    private UserAgent getBrowser(HttpServletRequest request) {
