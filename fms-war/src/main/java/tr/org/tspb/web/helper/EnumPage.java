package tr.org.tspb.web.helper;
...
public enum EnumPage {
    ...
    BULK_UPLOAD_PAGE(//
            "/bulkload/center.xhtml",
            "/bulkload/center.xhtml",
            "Admin",
            "İşlemler | Toplu Veri Yükleme",
            null,
            null,
            "/bulkload/north.xhtml",
            null
    ),
    MASAK_RISK(
            "/masakrisk/masak-riskler.xhtml",
            "/masakrisk/masak-riskler.xhtml",
            "Admin",
            "İşlemler | Dönem",
            null,
            null,
            "/masakrisk/masak-riskler-top.xhtml",
            null
    ),
    MASAK_RISK_SUB_MENU(
            "/masakrisk/masak-riskler-tedbirler.xhtml",
            "/masakrisk/masak-riskler-tedbirler.xhtml",
            "Admin",
            "İşlemler | Dönem",
            null,
            null,
            "/masakrisk/masak-riskler-tedbirler-top.xhtml",
            null
    ),
    FMS_PIVOT_1D(
