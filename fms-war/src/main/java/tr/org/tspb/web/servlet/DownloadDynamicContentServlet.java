 ...
 */
@WebServlet(name = "DownloadDynamicContentServlet", urlPatterns = {
    "/downloadDynamicContentServlet/*"},
        initParams = {
            @WebInitParam(name = "jasperPath",
                    value = ProjectConstants.PATH_JASPER_JRXML)
        })
public class DownloadDynamicContentServlet extends HttpServlet {
    ...
    private void safeProcessRequest(HttpServletRequest request,
            HttpServletResponse response) {
        try {
    ...
    private void processRequest(HttpServletRequest request,
        ...
        Reader reader = (Reader) request.getSession().
                getAttribute(
                        UYS_DOWNLOAD_READER);
        FmsForm selectedForm = (FmsForm) request.getSession().
                getAttribute(
                        UYS_SELECTED_FROM);
        String excelFormatPath = (String) request.getSession().
                getAttribute(
                        EXCEL_FORMAT_PATH);
        String excelLibraryPoi = (String) request.getSession().
                getAttribute(
                        EXCEL_LIBRARY_POI);
        Set uysDownloadRoles = (Set) request.getSession().
                getAttribute(
                        UYS_DOWNLOAD_ROLES);

        String downloadFileName = URLDecoder.decode(selectedForm.getName().
                concat(".xls"), "UTF-8");
        ...
        try {
            ...
            if (excelFormatPath != null) {
                writeToExistingExcel(excelFormatPath, list, columns, user_agent,
                        user_agent, baos, uysDownloadRoles);
            } else if (excelLibraryPoi != null) {
                writeToExcellWithPoi(excelFormatPath, list, columns, user_agent,
                        user_agent, baos);
            } else {
    ...
    public void writeToExcel(List<List<String>> reader, List<String> columns,
            String sessionID, String fileName, OutputStream outputStream) throws
            IOException {
    ...
    public void writeToExistingExcel(String excellFormatPath,
            List<List<String>> reader,
            List<String> columns, String sessionID, String fileName,
            OutputStream outputStream, Set roles) throws IOException {
        ...
        if (support_3131 == true && columns.indexOf("Konsolide") < 0) {
             ...
             */
            if ("/home/telman/ufrs_201306_balance_abstract_sablon.xls".equals(
                    excellFormatPath)) {
                excellFormatPath = "/home/telman/ufrs_201306_balance_abstract_sablon_solo.xls";
            } else if ("/home/telman/ufrs_201306_income_abstract_sablon.xls".
                    equals(excellFormatPath)) {
                excellFormatPath = "/home/telman/ufrs_201306_income_abstract_sablon_solo.xls";
            } else if ("/home/telman/ufrs_201306_income_detail_sablon.xls".
                    equals(excellFormatPath)) {
    ...
    public void writeToExcellWithPoi(String excellFormatPath,
            List<List<String>> reader, List<String> columns, String sessionID,
