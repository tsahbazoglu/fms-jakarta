    ...
    public void sendRequestData(QueueConnectionFactory queueConnectionFactory,//
        ...
        try {
            ...
            try {
                ...
                logger.info(MessageFormat.format(
                        "JMS Queue Connection had been successfully closed.", ""));
