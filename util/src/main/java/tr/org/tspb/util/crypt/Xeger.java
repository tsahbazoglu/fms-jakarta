...
/**
 * Copyright 2009 Wilfred Springer Copyright 2012 Jason Pell Copyright 2013
...
public class Xeger {
     ...
     * @param random The object that will randomize the way the String is
    ...
    /**
     * As {@link nl.flotsam.xeger.Xeger#Xeger(String, java.util.Random)},
     * creating a {@link java.util.Random} instance implicityly.
     */
    ...
    private void generate(StringBuilder builder, State state) {
        ...
        int nroptions = state.isAccept() ? transitions.size() : transitions.
                size() - 1;
        ...
        Transition transition = transitions.get(
                option - (state.isAccept() ? 1 : 0));
        appendChoice(builder, transition);
        generate(builder, transition.getDest());
    }

    private void appendChoice(StringBuilder builder, Transition transition) {
        char c = (char) Xeger.getRandomInt(transition.getMin(), transition.
                getMax(), random);
        builder.append(c);
    }
