...
public class RecurcivlyReplaceableDocument {
    ...
    public Object getValue(String... keys) {
        ...
        for (String key : keys) {
            if (value instanceof Document) {
                value = new RecurcivlyReplaceableDocument((Document) value).get(
                        key);
            } else {
    ...
    public Document replaceToDollar() {
        ...
        for (String key : document.keySet()) {
            ...
            String key_ = key.replace(DIEZ, DOLAR).
                    replace("!DOT!", ".");
            ...
            if (value == null) {
                ...
                result.put(key_, new RecurcivlyReplaceableDocument(
                        (Document) value).replaceToDollar());
            } else if (value instanceof Code) {
                value = new Code(value.toString().
                        replace(DIEZ, DOLAR).
                        replace("!DOT!", "."));
                result.put(key_, value);
