...
public class ProjectConstants {
     ...
     *
     */
    public static Pattern pattern_fms_crud = Pattern.compile(
            "fms_crud\\{\\{(.*?)\\}\\}");
    public static Pattern pattern_fms_filter = Pattern.compile(
            "fms_filter\\{\\{(.*?)\\}\\}");
    ...
    public static final String REPLACEABLE_KEY_WORD_FOR_THIS_FORM_KEY = "fms_code{{this_form_key}}";
    public static final String DOLAR_FMS_REF = "$fms-ref";
    public static final String FMS_ACTION_REF = "action-ref";
    ...
    public static final DateFormat SIMPLE_DATE_FORMAT__0 = new SimpleDateFormat(
            "dd.MM.yyyy");
    public static final DateFormat SIMPLE_DATE_FORMAT__1 = new SimpleDateFormat(
            "dd/MM/yyyy hh:mm:ss");
    public static final DateFormat SIMPLE_DATE_FORMAT__2 = new SimpleDateFormat(
            "dd MMMM yyyy ; yyyy.MM.dd", new Locale("tr", "TR"));
    public static final DateFormat SIMPLE_DATE_FORMAT__3 = new SimpleDateFormat(
            "dd MMMM yyyy hh:mm:ss", new Locale("tr"));
    public static final DateFormat SIMPLE_DATE_FORMAT__4 = new SimpleDateFormat(
            "yyyyMMddHHmm");
    public static final DateFormat SIMPLE_DATE_FORMAT__5 = new SimpleDateFormat(
            "yyyyMMdd_hhmmss");
    public static final DateFormat SIMPLE_DATE_FORMAT__6 = new SimpleDateFormat(
            "yyyyMMdd");
    public static final DateFormat SIMPLE_DATE_FORMAT__7 = new SimpleDateFormat(
            "HH:mm");
    ...
    public static final String CONFIG_ATTR_FIELD_ITEMS_SORT_LIST = "list";
    public static final String CONFIG_ATTR_FIELD_ITEMS_LIST = "list";
    public static final String CONFIG_ATTR_FIELD_ITEMS_FUNC = "func";
    public static final String CONFIG_ATTR_REF = "ref";
    ...
    public static final String EVENT_PRE_SAVE_ON_CHILD = "eventPreSaveOnChild";
    ...
    public static final String PROJECT_PROPERTIES_LOGO_LARGE = "LOGO_LARGE";
    public static final String PROJECT_PROPERTIES_LOGO_SMALL = "LOGO_SMALL";
    public static final String PROJECT_PROPERTIES_COPYRIGHT = "COPYRIGHT";
    ...
    public static final String ACTION_SEND_FORMS = "sendForms";
    ...
    // CONCATS
    public static final String METADATA_SELECTED_FORM_KEY = METADATA.concat(DOT).
            concat(SELECT_FORM_KEY);
    public static final String METADATA__SELECTED_FORM_KEY = METADATA.
            concat(DOT).
            concat(SELECTED_FORM_KEY);
    public static final String METADATA_CRUD_OBJECT_ID = METADATA.concat(DOT).
            concat(CRUD_OBJECT_ID);
    public static final String METADATA_USERNAME = METADATA.concat(DOT).
            concat("username");
    public static final String METADATA__MEMBER_NAME = METADATA.concat(DOT).
            concat(MEMBER_NAME);
    public static final String METADATA__SOURCE_TEXT = METADATA.concat(DOT).
            concat("sort_text");
    ...
    //AJAX IDS
    public static final String COMMA_SEMICOLON = ",:";
    public static final String ID_DLG_CTRL_AND_SAVE = "idDialogControlAndSave";
    public static final String ID_TO_BE_SIGNED_DLG = "idToBeSignedDialog";
    public static final String ID_MSG_DLG = "idMessageDialog,id-dlg-code";
    public static final String ID_DLGS = "id-dlgs";
    public static final String ID_CENTER_TOP = "idCenterTop";
    public static final String ID_CENTER_MIDDLE = "idCenterCenter";
    public static final String ID_DIM_BASED_DLGS = "id-dim-based-dlgs";
    public static final String ID_CRUD_OPS = "idCrudOperation";
    ...
    public static final String ID_2D_CURRENT_LIST = ID_TAB_VIEW.concat(":").
            concat("id2DCurrentObjectList");
    public static final String ID_2D_ACTION_FORM = ID_TAB_VIEW.concat(":").
            concat("id-2d-action-form");
    public static final String ID_2D_HISTORY_LIST = ID_TAB_VIEW.concat(":").
            concat("id2DHistoryObjectsList");
    public static final String ID_TWO_DIM_DLG_PNL = "";//"crud2dForm:crud_2d_dlg_panel";
    public static final String ID_DATATABLE_WF_HISTORY = "idTwoDlgTabView:id-dt-wf";
    public static final String ID_CONTENT = "";//ID_TAB_VIEW.concat(":").concat("idContentObjectList");
    public static final String ID_PNL_ESIGN_HISTORY = ID_TAB_VIEW.concat(":").
            concat("id_eimza_tarihce");
    public static final String ID_2D_DATA_TABLE = ID_TAB_VIEW.concat(":").
            concat("objectsDataTable");
    public static final String ID_ESIGN = "";//ID_TAB_VIEW.concat(":").concat("id_eimza");
    public static final String ID_UPLOADED_FILES = ID_TAB_VIEW.concat(":").
            concat("id-uploaded-files");
    public static final String ID_1D_INPUT_FILE_FORM = "";//ID_TAB_VIEW.concat(":").concat("idInputFileForm1D");
    public static final String ID_VERSION_TABLE = "";// "idVersionTable";
    public static final String ID_1D_FRM = "";//ID_TAB_VIEW.concat(":").concat("crud1dForm");
    public static final String ID_1D_PNL_UPL_FILE = "";
    public static final String ID_CURRENT_MYGRID_EDITABLE = ID_TAB_VIEW.concat(
            ":").
            concat("idCurrentMyGrid");
    public static final String ID_HISTORY_MYGRID_READONLY = ID_TAB_VIEW.concat(
            ":").
            concat("historyMyGridReadOnly");
    public static final String ID_2D_HISTORY = ID_TAB_VIEW.concat(":").
            concat("id2DHistoryObjectsList");
    public static final String ID_TABLE_UPLOADED_FILES = "idTwoDlgTabView:id2dUploadedFiles";
