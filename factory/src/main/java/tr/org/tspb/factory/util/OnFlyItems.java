...
//                items.add(new SelectItem(SelectOneObjectIdConverter.NULL_VALUE, SELECT_PLEASE));
            ...
            items.addAll(documentsToSelectItems(docs, myField.
                    getItemsAsMyItems().
                    getView()));
        ...
        switch (myField.getItemsAsMyItems().
            ...
            case code:
                items = codeToItems(myField.getItemsAsMyItems().
                        getCode(), autoCompleteSearch, roleMap);
                break;
            default:
    ...
    private List<SelectItem> listToItems(List documentItems) throws
        ...
        if (myField.getMyconverter() == null) {
            throw new UnsupportedOperationException(
                    "config error : converter is required : related key is : ".
                            concat(myField.getKey()));
        }
...
//                    items.add(new SelectItem(BsonConverter.NULL_VALUE, SELECT_PLEASE));
                ...
                throw new UnsupportedOperationException(
                        "engine does not support this type of converter.");
            }
        }
        ...
        for (Object itemValue : documentItems) {
            if (itemValue instanceof String) {
                ...
                String itemCode = selectItemDbObject.get(CODE).
                        toString();
                String itemName = selectItemDbObject.get(NAME).
                        toString();
