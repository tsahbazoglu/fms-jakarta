...
public class GuiService implements Serializable {
    ...
    private TwoDimDlgUi createTwoDimUi(FmsForm myForm) {
        ...
        for (String key : myForm.getFieldsKeySet()) {
            ...
            if (Tag.INPUT_FILE.getComponentName().
                ...
                if (fieldStructure.getFileType() != null) {
                    switch (fieldStructure.getFileType()) {
                        case "pdf":
                            twoDimDlgUi.setMongoUploadFileType(
                                    "/(\\.|\\/)(pdf)$/");
                            twoDimDlgUi.setInvalidFileMessage(
            ...
            if (!Tag.AUTO_COMPLETE.getComponentName().
                    equals(fieldStructure.getComponentType())) {
            ...
            fieldStructure.setReadonly(fieldStructure.isReadonly() || !myForm.
                    getMyActions().
                    isSave());
