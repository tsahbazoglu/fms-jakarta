...
public class FmsNamedQueries {
    ...
    public FmsNamedQueries(FmsForm myForm, RoleMap roleMap,
            UserDetail userDetail, MongoDbUtilIntr mongoDbUtil) throws
        ...
        List<Document> includeQuery = myNamedQueries.getList(INCLUDE,
                Document.class);
    ...
    private void runLoopBreak(List<Document> includeQuery, RoleMap roleMap,
            UserDetail userDetail, FmsForm myForm, MongoDbUtilIntr mongoDbUtil)
    ...
    private void applyQuery(Document doc, UserDetail userDetail, FmsForm myForm,
            MongoDbUtilIntr mongoDbUtil, RoleMap roleMap) throws
            RuntimeException {
        ...
        if (list != null) {
            ...
            if (facesContext != null) {
                map.put(CREATE_SESSIONID, ((HttpSession) facesContext.
                        getExternalContext().
                        getSession(false)).getId());
            }
            Document commandResult = mongoDbUtil.
                    runCommand(myForm.getDb(), func, map, roleMap.keySet());
