...
public class FmsHistoryConverterReadonly implements Converter {
    ...
    private static final DateFormat SIMPLE_DATE_FORMAT__0 = new SimpleDateFormat(
            "dd.MM.yyyy");
    private static final DateFormat SIMPLE_DATE_FORMAT__1 = new SimpleDateFormat(
            "dd/MM/yyyy hh:mm:ss");
    private static final DateFormat SIMPLE_DATE_FORMAT__2 = new SimpleDateFormat(
            "dd MMMM yyyy ; yyyy.MM.dd", new Locale("tr", "TR"));
    private static final DateFormat SIMPLE_DATE_FORMAT__3 = new SimpleDateFormat(
            "dd MMMM yyyy hh:mm:ss", new Locale("tr"));
    private static final DateFormat SIMPLE_DATE_FORMAT__4 = new SimpleDateFormat(
            "yyyyMMddHHmm");
    private static final DateFormat SIMPLE_DATE_FORMAT__5 = new SimpleDateFormat(
            "yyyyMMdd_hhmmss");
    private static final DateFormat SIMPLE_DATE_FORMAT__6 = new SimpleDateFormat(
            "yyyyMMdd");
    private static final DateFormat SIMPLE_DATE_FORMAT__7 = new SimpleDateFormat(
            "HH:mm");
    private static final DateFormat SIMPLE_DATE_FORMAT__8 = new SimpleDateFormat(
            "yyyy");
    ...
    public String getAsString(FacesContext context, UIComponent component,
        ...
        if (value instanceof Date) {
            ...
            String datePattern = (String) component.getAttributes().
                    get("datePattern");
            ...
            MyField myField = (MyField) component.getAttributes().
                    get("myField");
            ...
            if (myField.getMyconverter() instanceof BsonConverter) {
                if (value instanceof String) {
                    ...
                    return myField.getCacheBsonConverter().
                            getOrDefault(value, "no name on key ".concat(value.
                                    toString()));
                }
            }
