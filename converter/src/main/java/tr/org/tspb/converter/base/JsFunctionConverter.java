...
public class JsFunctionConverter implements Converter {
    ...
    public Object getAsObject(FacesContext context, UIComponent component,
            String value) {//view to model

        Boolean myCalculateOnSave = (Boolean) component.getAttributes().
                get(
                        ProjectConstants.CALCULATE_ON_SAVE);

        if (Boolean.TRUE.equals(myCalculateOnSave)) {
            Map crudObject = (Map) component.getAttributes().
                    get("crudObject");
            String fieldKey = (String) component.getAttributes().
                    get(
                            ProjectConstants.FIELD_KEY);

            Object calculatedValue = calculateValue(crudObject, fieldKey,
                    context);
    ...
    public String getAsString(FacesContext context, UIComponent component,
            Object value) {//model to view

        Boolean myCalculateOnListView = (Boolean) component.getAttributes().
                get(
                        ProjectConstants.CALCULATE_ON_LIST_VIEW);
        Boolean myCalculateOnCrudView = (Boolean) component.getAttributes().
                get(
                        ProjectConstants.CALCULATE_ON_CRUD_VIEW);

        if (Boolean.TRUE.equals(myCalculateOnListView) || Boolean.TRUE.equals(
                myCalculateOnCrudView)) {
            Map crudObject = (Map) component.getAttributes().
                    get("crudObject");
            String fieldKey = (String) component.getAttributes().
                    get(
        ...
        Number divider = (Number) component.getAttributes().
                get("divider");
        String format = (String) component.getAttributes().
                get("converterFormat");

        Number minFractationDigits = (Number) component.getAttributes().
                get(
        ...
        NumberFormat numberFormat = getNumberFormat(component,
                minFractationDigits);
    ...
    public NumberFormat getNumberFormat(UIComponent component,
            Number minFractationDigits) {

        String instance = (String) component.getAttributes().
                get(
                        "converterInstance");
        String language = (String) component.getAttributes().
                get("language");
        String country = (String) component.getAttributes().
                get("country");
        Object maxFractationDigits = component.getAttributes().
                get(
        ...
        if (minFractationDigits instanceof Number) {
            numberFormat.
                    setMinimumFractionDigits(minFractationDigits.intValue());
        }
        if (maxFractationDigits instanceof Number) {
            numberFormat.setMaximumFractionDigits(
                    ((Number) maxFractationDigits).intValue());
        }

        return numberFormat;
    }

    public String calculateNDSum(String db, Map searchMap, Code code,
            Boolean isMoney) {
    ...
    public String calculateNDSubSum(Map searchMap, Code code, Boolean isMoney,
        ...
        try {
            ...
            Document commandResult = mongoDbUtil.runCommand(UYSDB, codeString,
                    searchObject, parameterField);
    ...
    private Object calculateValue(Map crudObject, String fieldKey,
        ...
        FmsForm myFrom = (FmsForm) context.getExternalContext().
                getSessionMap().
                get(SESSION_ATTR_SELECTED_FORM);
