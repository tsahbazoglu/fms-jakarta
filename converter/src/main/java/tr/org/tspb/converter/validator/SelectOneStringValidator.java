...
public class SelectOneStringValidator implements Validator, ConverterAttrs {
    ...
    public static boolean isNullOrOther(String value) {
        return value == null ? true : OTHER_VALUE.equals(value) || NULL_VALUE.
                equals(value);
    }
    ...
    public void validate(FacesContext context, UIComponent component,
        ...
        Boolean submitAllow = "true".equals((String) component.getAttributes().
                get(SUBMITALLOW));
        EnumConverterParam converterParam = (EnumConverterParam) component.
                getAttributes().
                get(CONVERTER_PARAM_NAME);

        String otherFieldId = (String) component.getAttributes().
                get(OTHERFIELDID);
        if (otherFieldId != null) {
            UIComponent uiComponent = (UIComponent) context.getViewRoot().
                    findComponent(otherFieldId);
            if (uiComponent != null) {
