...
public class SelectOneDBObjectConverter implements Converter, ConverterAttrs {
    ...
    public static final Document NULL_VALUE = new Document("code", "null").
            append("name", "null");
    ...
    public Object getAsObject(FacesContext fc, UIComponent component,
        ...
        Object obj = myField.getCacheBsonConverter().
                get(value);
        ...
        if ((obj == null || NULL_VALUE.equals(obj)) && required) {
            ...
            FacesMessage facesMessageRequired = new FacesMessage(//
                    ...
                    MessageFormat.format("[{0}] {1}", label,
                            MessageBundleLoader.getMessage("requiredMessage")),//
                    "*");
    ...
    public String getAsString(FacesContext context, UIComponent component,
        ...
        if (value instanceof DBObject) {
            ...
            String projectKey = (String) component.getAttributes().
                    get(PROJECT_KEY);
            String upperNode = (String) component.getAttributes().
                    get(UPPER_NODE);
            String formKey = (String) component.getAttributes().
                    get(FORM_KEY);
            String fieldKey = (String) component.getAttributes().
                    get(FIELD_KEY);
            String code = (String) ((Document) value).get(CODE);
            String lastKey = MySessionStore.
                    createCacheKey(projectKey, upperNode, formKey, fieldKey,
                            code);
