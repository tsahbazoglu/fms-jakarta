    ...
    public Object getAsObject(FacesContext context, UIComponent component,
        ...
        if (mapRequredControl instanceof Map) {
            String fieldKey = (String) component.getAttributes().
                    get(FIELD_KEY);
            Boolean required2 = (Boolean) ((Map) mapRequredControl).
                    get(fieldKey);
        ...
        String max = (String) component.getAttributes().
                get("maxMoney");//kuruş degil,TL anlamındadır
        ...
        facesMessageRequired = new FacesMessage(//
                FacesMessage.SEVERITY_ERROR, //
                MessageFormat.format("[{0}] {1}", label, MessageBundleLoader.
...
//                return null;
                ...
                facesMessageConverter = new FacesMessage(//
                        ...
                        MessageFormat.format(
                                "[{0}] {1} - {2} aralığında pozitif tamsayı olmak zorunda",//
                                label, 0D, maxMoney),//
                        "*");
                throw new ConverterException(facesMessageConverter);
            } else {
