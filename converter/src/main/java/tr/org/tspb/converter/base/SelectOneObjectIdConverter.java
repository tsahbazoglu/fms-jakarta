...
public class SelectOneObjectIdConverter implements Converter, ConverterAttrs {
    ...
    public Object getAsObject(FacesContext context, UIComponent component,
        ...
        Object disabled = component.getAttributes().
                get("disabled");
        if (disabled == null) {
            ValueExpression ve = ((HtmlInputText) component).getValueExpression(
                    "disabled");
            if (ve != null) {
    ...
    public String getAsString(FacesContext context, UIComponent component,
         ...
         */
        Object mongoField = component.getAttributes().
                get("mongoField");

        boolean readonly = Boolean.TRUE.equals(component.getAttributes().
                get("readonly"));

        if (mongoField != null && !mapClientIdPerMongoKey.
                containsKey(mongoField)) {
            mapClientIdPerMongoKey.put(mongoField, component.
                    getClientId(context));
        }
        if (mongoField != null && !mapComponentPerMongoKey.containsKey(
                mongoField)) {
        ...
        if (value instanceof ObjectId) {
            ...
            if (!MySessionStore.map.containsKey(asStringValue)) {
                MySessionStore.map.put(asStringValue.toString(),
                        (ObjectId) value);
            }
