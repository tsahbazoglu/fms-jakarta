...
public class MySessionStore implements Serializable {
    ...
    public static String createCacheKey(String projectKey, String upperNode,
            String formKey, String fieldKey, String code) {
    ...
    public static String createSessionKey(String projectKey, String upperNode,
            String formKey, String fieldKey) {
        StringBuilder sb = new StringBuilder();
        sb.append(projectKey);
        sb.append(SPLITTER);
        sb.append(upperNode);
