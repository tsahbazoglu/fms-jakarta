package tr.org.tspb.datamodel.wf;
...
public class MyRule implements Serializable {
    ...
    public MyRule(Document dbo, FmsScriptRunner fmsScriptRunner) {
        ...
        this.code = state.get(ProjectConstants.CODE).
                toString();
        this.name = state.get(ProjectConstants.NAME).
                toString();
        ...
        if (onEntryFrom == null) {
            throw new RuntimeException(
                    "ontry event had not been defined on step : " + this.
                            getCode() + " : " + this.getName());
        }
    ...
    public void maskFields(FmsForm myForm, Map searchObject,
    ...
    public void arrangeActions(FmsForm myForm, RoleMap roleMap,
            Document searchObject) {
        this.myActions = new MyActions.Build(myForm.getMyProject().
                getViewerRole(), myForm.getDb(),
                roleMap, searchObject, dbo.get(FORMACTIONS), fmsScriptRunner,
                userDetail)
                .init().
                base().
                build();
    ...
    public void arrangeActions(FmsForm myForm, RoleMap roleMap,
            Document searchObject, MyMap crudObject, Object actions) {
        this.myActions = new MyActions.Build(myForm.getMyProject().
                getViewerRole(), myForm.getDb(),
