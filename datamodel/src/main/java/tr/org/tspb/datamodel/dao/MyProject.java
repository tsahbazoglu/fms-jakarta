...
public class MyProject {
    ...
    public MyProject(Document docProject, String loginDetailDb,
        ...
        if (docProject.get(VIEWER_ROLE) != null) {
            this.viewerRole = docProject.get(VIEWER_ROLE).
                    toString();
            this.adminAndViewerRole = adminRole.concat(COMMA).
                    concat(viewerRole);
        }
        if (docProject.get(USER_ROLE) != null) {
            this.userRole = docProject.get(USER_ROLE).
                    toString();
        }
        this.welcomePage = docProject.get(WELCOME_PAGE).
                toString();

        this.key = docProject.get(FORM_KEY).
                toString();
    ...
    /**
     * @return the checkJsonSchema
     */
    public boolean isCheckJsonSchema() {
