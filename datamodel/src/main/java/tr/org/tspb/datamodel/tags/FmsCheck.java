...
public class FmsCheck {
    ...
    private FmsCheck(Document checkDoc, Map filter, ObjectId loginMemberId,
        ...
        this.filter = FmsQuery
                .buildListQuery(checkDoc.getList("query", Document.class),
                        filter, fmsScriptRunner, loginMemberId);
    ...
    public static FmsCheck build(Document checkDoc, Map filter,
