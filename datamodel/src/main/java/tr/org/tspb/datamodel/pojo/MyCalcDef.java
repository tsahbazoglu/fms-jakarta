...
public class MyCalcDef {
    ...
    private final List<String> calculatedFormulaSupportedElementKeys = Arrays.
            asList(//
                    "search", VALUE_KEY, X_CODE, Y_CODE, "X-IKS", "Y-IGREK",
                    PERIOD, FORM,//
    ...
    public MyCalcDef(Document dbo) {
        ...
        droolsRuleCoordinate = new MyCalcCoordinate((Document) dbo.get(
                DROOLS_RULE_COORDINATE));
