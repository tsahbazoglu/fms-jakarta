...
public class FmsTableDataModel extends LazyDataModel<Map> {
    ...
    @Override
    public List<Map> load(int first, int pageSize, Map<String, SortMeta> sortBy,
        ...
        try {
            ...
            listOfData = fmsOnFlyData.findLazyData(first, pageSize, sortMap);
            return listOfData;
        } catch (Exception ex) {
            fmsOnFlyData.warn(this.getClass().
                    getName(), "load data", ex);
