...
public class OutputProgressModel {
    ...
    /**
     * Gets the Progress message. If the progressMessageEnabled attribute is set
     * to false an empty String is returned. This ensure that the component will
     * use its default percent value as the progress message.
     *
    ...
    /**
     * Gets the Progress completed message. If the completedMessageEnabled
     * attribute is set to false an empty String is returned. This ensure that
     * the component will use its default completed message instead of the last
     * entered custom message.
     *
     * @return current value of progress bar if progressMessageEnabled is true,
     * otherwise an empty string is returned.
     */
