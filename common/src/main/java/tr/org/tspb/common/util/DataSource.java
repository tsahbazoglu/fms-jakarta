...
public abstract class DataSource {
     ...
     */
    protected DataPage getDataPage(int startRow, int pageSize, int dimesion,
            FmsForm form) {
...
//        }
        //BEGIN : COLLECT previously selected objects/rows
        lazyData = findPageData(sortColumnName, sortAscending, startRow,
                endIndex - startRow, form);
