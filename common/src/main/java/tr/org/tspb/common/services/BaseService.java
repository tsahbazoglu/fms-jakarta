...
public class BaseService extends AbstractSrv {
    ...
    public void init() {
        ...
        switch (selectProperties) {
            case PRODUCT:
            case TEST:
                props = mongoDbUtil.findOne("configdb", "properties",
                        new Document(FORM_KEY, "product"));
                if (props == null) {
                    throw new RuntimeException(
                            "mongodb project live properties resolved to empty");
                }
    ...
    public String getLogoLarge() {
        return appProperties.logoLarge;
    }

    public String getLogoSmall() {
        return appProperties.logoSmall;
    }

    public String getCopyrightInfo() {
        return appProperties.copyrightInfo;
    }
    ...
    public String getWelcomePage() {
        return HtmlFlow.doc(System.out) // .view()
                .
                html().
                head().
                style().
                text(
                        ".div-center { margin: auto; width: 50%; text-align: center; padding-top: 180px; }"
                        + ".p-class { font-size: 34px; font-weight: bold; }"
                ).
                __().
                __().
                body().
                div().
                attrClass("div-center").
                img().
                attrSrc("/images/tspb_logo_large.png").
                attrWidth(400L).
                __().
                p().
                attrClass("p-class").
                text(appProperties.getWelcomePageContent()).
                __().
                __().
                __().
                __().
    ...
    public class AppProperties {
        ...
        public AppProperties(Properties document) {
            googleRecaptchaSecret = document.
                    getProperty("googleRecaptchaSecret");
            mainProjectCode = document.getProperty(
                    ProjectConstants.MAIN_PROJECT_CODE);
            ...
            delegatedMemberFieldName = document.getProperty(
                    ProjectConstants.DELEGATED_MEMBER_FIELD_NAME);
            delegatingMemberFieldName = document.getProperty(
                    ProjectConstants.DELEGATING_MEMBER_FIELD_NAME);
            delegatingFormFieldName = document.getProperty(
                    ProjectConstants.DELEGATING_FORM_FIELD_NAME);
            ...
            pdfTool = document.getProperty(
                    ProjectConstants.CUSTOM_RESOURCE_PDFTOOL, PATH_PDF_TOOLS);
            tmpDownloadPath = document.getProperty(
                    ProjectConstants.PATH_UYS_EXPORT, "/tmp/fms/download");
