...
public abstract class MyMapReduce {
    ...
    public abstract void map(Map recordMap);

    public abstract Serializable reduce(Map key, List<Serializable> values)
    ...
    public Map<Map, Serializable> mapReduce(List<DocumentRecursive> collection)
            throws MoreThenOneInListException {
