...
public class SimplePivotCtrl extends SimplePivotCtrlAdmin {
    ...
    public void init(FmsForm myForm) {
        ...
        } else if (loginController.isUserInRole(myForm.getMyProject().
                getUserRole())) {
    ...
    public String save() {
        ObjectId loginID = loginController.getLoggedUserDetail().
                getDbo().
                getObjectId();
    ...
    public PivotRecord findOne() {
        ...
        PivotRecord record = PivotRecord.toObject(itemProvider,
                mongoDbUtil.findOne(myForm.getDb(),
                        myForm.getTable(),
                        Filters.eq("member", loginController.
                                getLoggedUserDetail().
                                getDbo().
                                getObjectId())));
    ...
    public List<String> getSelectedFormFieldKeySetAsList() {
        ...
        for (String key : myForm.getFieldsKeySet()) {
            if (loginController.isUserInRole(myForm.getField(key).
                    getAccesscontrol())) {
                list.add(key);
            }
        }
        Collections.sort(list, new Comparator<String>() {
            ...
            public int compare(String t, String t1) {
                String nameCurrent = myForm.getField(t).
                        getOrder().
                        toString();
                String nameNext = myForm.getField(t1).
                        getOrder().
                        toString();
