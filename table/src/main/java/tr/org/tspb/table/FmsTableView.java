...
public abstract class FmsTableView extends AbstractViewer {
    ...
    public void drawGUI(FmsForm myForm, Document filter) throws Exception {
        ...
        if (myForm == null || myForm.getKey() == null || SelectOneStringConverter.NULL_VALUE.
                equals(myForm.getKey())) {
        ...
        if (myForm.getAccessControlLevelTwo() != null) {
            ...
            if (result == null) {
                dialogController.showPopupInfo((String) message.get("norecord"),
                        MESSAGE_DIALOG);
                return;
            }
            ...
            if (HAYIR.equals(returnValue)) {
                dialogController.showPopupInfo((String) message.
                        get("noresponse"), MESSAGE_DIALOG);
            }
        }
        ...
        if (myForm != null) {
            for (String key : myForm.getFieldsKeySet()) {
                ...
                if (myField.isReportRendered()) {
                    ...
                    if (loginController.isUserInRole(accesscontrol) || loginController.
                            isUserInRole(visibleValue)) {
